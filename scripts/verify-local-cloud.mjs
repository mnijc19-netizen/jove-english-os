...
try {
  ...
  const suites = ['sync', 'services', 'content', 'speech', 'external-catalog', 'language-sync', 'recording-capacity', 'recording-maintenance']
  ...
  process.stdout.write(`Dedicated Jove local backend verified: ${expected.length} migrations, ${suites.length} SQL suites. This is not production acceptance.\n`)
} catch (error) {
