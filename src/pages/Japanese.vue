...
function sessionPath(saved: StudySession) {
  return saved.kind === 'japanese-review' ? '/ja/review' : saved.kind === 'japanese-dialogue' ? '/ja/talk' : saved.kind === 'japanese-reading' ? '/ja/read' : saved.kind === 'japanese-extensive' ? '/ja/books' : '/ja'
}
