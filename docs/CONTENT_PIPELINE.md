...
| Hacker Public Radio | [RSS](https://hackerpublicradio.org/hpr_ogg_rss.php); bounded publisher-specific discovery gives [hpr4721 SRT](https://hpr.nyc3.cdn.digitaloceanspaces.com/eps/hpr4721/hpr4721.srt),1421cues. | [Contribution policy](https://hackerpublicradio.org/contribute.html) CC BY-SA4.0; expressly says whole audio is not moderated. Latest September7. Hobbies/personal experiences, varied accents; large Ogg needs a real decoder before short-clip approval. |
