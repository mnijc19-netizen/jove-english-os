...
### Next English reading source screened, not implemented/admitted

September20 primary-source check: British Council's [reading overview](https://learnenglish.britishcouncil.org/free-resources/reading) and its A1/A2/B1/B2/C1 directories describe CEFR-organized practice, from everyday messages to more complex texts. The former `/skills/reading/...` addresses redirect to `/free-resources/reading/{a1,a2,b1,b2,c1}`; use verified canonical paths in any future adapter. This is a finite graded reserve, not a promise of daily newly published stories.

[British Council terms](https://www.britishcouncil.org/terms), sections10/14, generally allow text links to freely accessible service pages, but not copied/rehosted/modified material or media deep links removed from their original context, and no implied endorsement. A proposed integration must therefore keep complete original lesson pages at the publisher, retain attribution and only store link metadata plus the learner's own work. Do not fetch publisher book/article bodies into AI prompts or republish their exercises. The current English `ReadingPractice` and reading assessments remain separate; an external page cannot provide its reading-speed/coverage/verified-comprehension telemetry. This source is only screened: no adapter, imported material, auto-plan or production activation is claimed here.
